<?php
// We want to be able to do work on Http requests and responses without loading an entire framework.
// It may not be necessary to build an entire application in Middleware (though it is possible)
...
echo "\r\n==== Removed String Middleware (no conversion) ===\r\n";
